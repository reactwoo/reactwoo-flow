...
class RWF_CPT {
		...
		return array(
			...
			'agent_overrides' => array(
				...
				'fields' => array(
					...
					'override_qa_provider' => array(
						'label'       => __( 'QA Provider', 'reactwoo-flow' ),
						'type'        => 'select',
						'options'     => RWF_Agent::get_providers(),
						'description' => __( 'Optional per-item override for QA review runs.', 'reactwoo-flow' ),
						'empty_label' => __( 'Site default', 'reactwoo-flow' ),
					),
					'override_qa_model' => array(
						'label'       => __( 'QA Model', 'reactwoo-flow' ),
						'type'        => 'text',
						'description' => __( 'Leave empty to use the site default model.', 'reactwoo-flow' ),
					),
					'override_ux_provider' => array(
						'label'       => __( 'UX Provider', 'reactwoo-flow' ),
						'type'        => 'select',
						'options'     => RWF_Agent::get_providers(),
						'description' => __( 'Optional per-item override for UX review runs.', 'reactwoo-flow' ),
						'empty_label' => __( 'Site default', 'reactwoo-flow' ),
					),
					'override_ux_model' => array(
						'label'       => __( 'UX Model', 'reactwoo-flow' ),
						'type'        => 'text',
						'description' => __( 'Leave empty to use the site default model.', 'reactwoo-flow' ),
					),
				),
			...
			'release_notes' => array(
				'title'  => __( 'Release Notes', 'reactwoo-flow' ),
				'fields' => array(
					'release_notes_markdown' => array(
						'label'       => __( 'Release Notes Markdown', 'reactwoo-flow' ),
						'type'        => 'textarea',
						'description' => __( 'Generated by the release agent from item context, triage, and specification. Edit before export.', 'reactwoo-flow' ),
					),
					'release_notes_generated_at' => array(
						'label' => __( 'Release Notes Generated At', 'reactwoo-flow' ),
						'type'  => 'text',
					),
				),
			),
			'qa_review' => array(
				'title'  => __( 'QA Review', 'reactwoo-flow' ),
				'fields' => array(
					'qa_review_markdown' => array(
						'label'       => __( 'QA Review Markdown', 'reactwoo-flow' ),
						'type'        => 'textarea',
						'description' => __( 'Generated by the QA agent for test planning and release readiness.', 'reactwoo-flow' ),
					),
					'qa_review_generated_at' => array(
						'label' => __( 'QA Review Generated At', 'reactwoo-flow' ),
						'type'  => 'text',
					),
				),
			),
			'ux_review' => array(
				'title'  => __( 'UX Review', 'reactwoo-flow' ),
				'fields' => array(
					'ux_review_markdown' => array(
						'label'       => __( 'UX Review Markdown', 'reactwoo-flow' ),
						'type'        => 'textarea',
						'description' => __( 'Generated by the UX agent for journey and hierarchy review.', 'reactwoo-flow' ),
					),
					'ux_review_generated_at' => array(
						'label' => __( 'UX Review Generated At', 'reactwoo-flow' ),
						'type'  => 'text',
					),
				),
			),
			'integrations' => array(
				...
				'fields' => array(
					...
					'jira_status'         => array(
						'label' => __( 'Jira Status', 'reactwoo-flow' ),
						'type'  => 'text',
					),
					'jira_status_synced_at' => array(
	...
	public static function get_all_field_keys() {
		$keys = array( 'ai_analyzed', 'ai_analyzed_at', 'ai_raw_response', 'specification_generated', 'specification_raw_response', 'release_notes_generated', 'release_notes_raw_response', 'qa_review_generated', 'ux_review_generated', 'triage_agent_execution', 'specification_agent_execution', 'development_agent_execution', 'release_agent_execution', 'qa_agent_execution', 'ux_agent_execution', 'development_handoff_prepared', 'development_handoff_prepared_at', 'agent_runs', 'status_changed_at', 'status_history' );
	...
	/**
	 * Determine whether an item has generated release notes saved.
	 *
	 * @param int $post_id Post ID.
	 * @return bool
	 */
	public static function is_release_notes_generated( $post_id ) {
		return 'yes' === self::get_meta( $post_id, 'release_notes_generated' );
	}

	/**
	 * Determine whether an item has a generated QA review saved.
	 *
	 * @param int $post_id Post ID.
	 * @return bool
	 */
	public static function is_qa_review_generated( $post_id ) {
		return 'yes' === self::get_meta( $post_id, 'qa_review_generated' );
	}

	/**
	 * Determine whether an item has a generated UX review saved.
	 *
	 * @param int $post_id Post ID.
	 * @return bool
	 */
	public static function is_ux_review_generated( $post_id ) {
		return 'yes' === self::get_meta( $post_id, 'ux_review_generated' );
	}

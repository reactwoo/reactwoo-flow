...
class RWF_CPT {
	...
	public static function get_all_field_keys() {
		$keys = array( 'ai_analyzed', 'ai_analyzed_at', 'ai_raw_response', 'specification_generated', 'specification_raw_response', 'release_notes_generated', 'release_notes_raw_response', 'triage_agent_execution', 'specification_agent_execution', 'development_agent_execution', 'release_agent_execution', 'development_handoff_prepared', 'development_handoff_prepared_at', 'agent_runs', 'status_changed_at', 'status_history' );
